...
class TilFilter(object):
  '''
    This class implements a filtering-in set operation, ie, jogos with a certain patterns will be filtered in
    ...
    Only jogos with those slots_values will be filtered in.
