...
from fs.jogosfs import jogos_functions_dependent as jogos_fd # get_line_patterns, get_column_patterns etc.
...
def filter_in_those_within_coincides_histogram_range(jogo, coincides_ranges, up_to_nDoConc=None, LOOKUP_DEPTH=1000):
  ...
  This coincides_histogram is got from a "jogosfs function: get_coincides_histogram_against_a_lookup_depth()".
